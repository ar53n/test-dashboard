...
Дерево и таблица рядом, поиск по названию и AI-фильтр на естественном языке.

![Демо: дерево и таблица рядом, поиск и AI-фильтр](docs/screenshots/demo-desktop.gif)

### Демо на телефоне

AI-фильтр в таблице, переключение на дерево и прокрутка поддеревьев с live-обновлениями.

<img src="docs/screenshots/demo.gif" alt="Демо: таблица с AI-фильтром и дерево на узком экране" width="400">
